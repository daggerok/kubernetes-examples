#!/usr/bin/env bash
# ORIGINALLY TAKEN FROM HERE: https://github.com/superseb/multipass-k3s/ file multipass-k3s.sh
# RAW FILE: https://raw.githubusercontent.com/superseb/multipass-k3s/master/multipass-k3s.sh
